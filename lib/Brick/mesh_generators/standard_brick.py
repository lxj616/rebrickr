...
def makeStandardBrick(dimensions:dict, brickSize:list, type:str, circleVerts:int=16, detail:str="LOW", logo:Object=None, stud:bool=True, cm:CollectionProperty=None, bme:bmesh=None):
    ...
    # add studs
    if stud: addStuds(dimensions, height, brickSize, cm.brickType, circleVerts, bme, v5=v5, v6=v6, v7=v7, v8=v8, hollow=brickSize[2] > 3 or "HOLES" in type, loopCutCylinders=cm.loopCutCylinders)
